...
import com.xiaoma.actions.ScreenShot;
...
/**
 * Created by xiaoma on 2018/1/23.
 */
public class MyAssert extends Assert {
    private final static LoggerControler logger = LoggerControler.getLoggerControler(MyAssert.class);
